...
export default function LoginPage() {
  ...
  const mesaId =
    ...
    useState(() => {
      const mesaId = searchParams.get("mesa") ?? Array.from(searchParams.keys())[0] ?? "";
      if(mesaId) setqrvalue(mesaId);
      else setqrvalue("01K8S06QZ563VVHH8N5GZBBRAD"); // valor por defecto para pruebas
    }, );
